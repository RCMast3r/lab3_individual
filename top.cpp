...
// https://www.csl.cornell.edu/~zhiruz/pdfs/matraptor-micro2020.pdf

// CSR (compressed sparse row): value, column index, row index
// CSC (compressed row storage): value, column index, row index
